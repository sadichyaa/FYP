...
{
	$sql = "UPDATE customer SET customer_name='" . $_POST['customer_name'] . "',email_id='" . $_POST['email_id'] . "',address='" . $_POST['address'] . "',mobile_no='" . $_POST['mobile_no'] . "' WHERE  customer_id='". $_SESSION['customer_id'] ."'";

...
if(isset($_POST['submit']))
{
    ...
    else
    {
        ...
        {
            $sql ="INSERT INTO customer(customer_name,email_id,password,mobile_no,status) 
                   VALUES('$_POST[customer_name]','$_POST[email_id]','$_POST[password]','$_POST[mobile_no]','Active')";

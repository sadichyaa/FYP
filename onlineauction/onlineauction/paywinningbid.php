...
function sendemail_verify($email_id,$verify_token)
{
    ...
    $mail->Host       = "mail.myprojectcoding.xyz";            
    $mail->Username   = "onlineauctionprojectmail@myprojectcoding.xyz";                     
    $mail->Password   = "h?eeL$9e0lp6"; 
                                  
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;             
    $mail->Port       = 26;       
    
    $mail->setFrom("onlineauctionprojectmail@myprojectcoding.xyz",$mailsender);
    $mail->addAddress($email_id);    
    
    $mail->isHTML(true);                                  
    $mail->Subject = 'Payment Verification from Second Chance Thrift Auction';

    $email_template=" 
    <h2> You have used your card to pay for the product with Second Chance Thrift Auction </h2>
    <h3> Please verify your payment with given link.</h5>
    <br/><br/>

    <h4><a href ='http://localhost/onlineauction/winingbidverify.php?token=$verify_token'> Click Me </a><h4>
...
if(isset($_POST['submit']))
{
	...
	$sql ="UPDATE customer SET address='$_POST[address]',mobile_no='$_POST[mobile_no]' WHERE customer_id='$_POST[customer_id]'";
	...
	$sql = "INSERT INTO  payment (payment_type,paid_amount,paid_date,status,customer_id,product_id,bidding_id) VALUES('$_POST[card_type]','$_POST[paid_amount]','$dt','Active','$_POST[customer_id]','$_POST[product_id]','$_POST[bidding_id]')";
	$qsql = mysqli_query($con,$sql);

	

	$sql = "INSERT INTO  billing (email_id,purchase_date,product_id,purchase_amount,payment_type,card_type,card_number,expire_date,cvv_number,card_holder,verify_token,status,customer_id) VALUES(' $_POST[email_id]','$dt','$_POST[product_id]','$_POST[paid_amount]','Winners','$_POST[card_type]','$_POST[card_number]','$_POST[expire_date]-01','$_POST[cvv_number]','$_POST[card_holder]','$verify_token','Active','$_SESSION[customer_id]')";
	$qsql = mysqli_query($con,$sql);
	
	if($qsql)
        {
			$email_id=$_POST['email_id'];
            sendemail_verify("$email_id","$verify_token");
			echo "<script>alert('Check your email to verify payment.');</script>";
	...
	<div class="col-md-12 col-sm-12 "><hr><center><h3>Payment Panel</h3></center><hr></div>
        <div class="col-md-6 col-sm-6 ">
			...
			<div class="col-md-12">
				...
				<input name="email_id" class="form-control" type="text" readonly value='<?php echo $rscustomer['email_id']; ?>'>
				<br>
            </div>
            <div class="col-md-12">
        ...
        <div class="col-md-6 col-sm-6 ">
            ...
            <div class="col-md-12">
				...
				<input name="card_holder" class="form-control" placeholder="card holder"  value="<?php echo $rsedit['card_holder']; ?>" required>
				<br>
            </div>
            <div class="col-md-12">
				<label class="control-label">Card number</label>
				<input name="card_number" class="form-control" placeholder="Card number"  value="<?php echo $rsedit['card_number']; ?>"required>
				<br>
            </div>
            <div class="col-md-12">
				<label class="control-label">CVV number</label>
				<input name="cvv_number" class="form-control" placeholder="CVV number"  value="<?php echo $rsedit['cvv_number']; ?>"required>
				<br>
            </div>
            <div class="col-md-12">
				<label class="control-label">Expiry date</label>
				<input name="expire_date" type="month" class="form-control" placeholder="expire date"  value="<?php echo $rsedit['expire_date']; ?>" min="<?php echo date("Y-m"); ?>"required>
				<br>
            </div>
            <!-- <div class="col-md-12">
				<label class="control-label">CVV number</label>

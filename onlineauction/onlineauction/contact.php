...
if(isset($_POST['submit']))
{
	...
	$owneremailid="istitest21@gmail.com";
	$title = "Enquiry Mail";
	$msg = "
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6 col-xs-12 plr-0">
                            <div class="contact-address-area">
                                ...
                                <ul>
                                    <li>
                                        <i class="fa fa-fax">&nbsp;</i> Address : SecondChance, Pepsicola,Kathmandu</li>
                                    <li>
                                        <i class="fa fa-phone">&nbsp;</i> secondchance@gmail.com</li>
                                    <li>
                                        <i class="fa fa-envelope-o"></i>&nbsp; 9862222222</li>
                                </ul>
                            </div>
                        </div>

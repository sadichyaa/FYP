                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-2 col-md-3 md-custom-12">
                                <!-- logo start -->
                                <div class="logo">
                                    <a href="index.php"><img src="img/logo/logoo.PNG" alt=""></a>
                                </div>
                                <!-- logo end -->
                            </div>
...
<li><a href="viewbillingcustomer.php">View Trasaction</a></li>
	...
	?>
		...
		<li class="drodown-show"><a href="#"> Users <i class="fa fa-angle-down"></i></a>
			...
			{
			?>
		<li class="drodown-show"><a href="#"> Categories <i class="fa fa-angle-down"></i></a>
			<ul class="open-dropdown setting">
                        ...
                        <div class="row">
                            <div class="col-lg-12 pl-5"> 
                                ...
                                <div class="hot-line-area">
                                    <div class="phone">
                                        Customer Support: <span>+977-9821677333 </span>
                                    </div>
                                </div>
                                <!-- hot-line-area end -->
...
<div class="item-total" >Rs.<?php echo $accbalamt; ?></div>
</a>
</li>
<?php
}
...
<div class="slider-main-area">
	<div class="slider-active owl-carousel">
		...
		<div class="slider-wrapper" style="background-image:url(img/slider/bgimage.jpg); width: 100%;height: 100vh; filter: brightness(70%) ">
			<div class="container-fluid">
				<div class="row">
					<div class="col">
						<div class="slider-text-info style-2 text-center slider-text-animation">
							<h1 class="title1" ><span class="text"> Second Chance Online Thrift Auction.</span></h1>
						
							<p style="background-color:powderblue;font-weight: bold; color:black;">SELL YOUR OLD STUFF. </span> GET NEW STUFF YOU LOVE.</p>
		...
		<!-- slider-wrapper start -->
		<!-- <div class="slider-wrapper" style="background-image:url(img/slider/home-3-01.jpg);width: 100%; filter: brightness(70%) ">
			<div class="container-fluid">
				<div class="row">
					<div class="col">
						<div class="slider-text-info style-2 text-center slider-text-animation">
							<h1 class="title1"><span class="text">Bid For Products..</span></h1>
							<p>Convinient auction platform..</p>
							<div class="slier-btn-1">
								<a title="Bid now" href="latestauction.php?auctiontype=Latest%20Auctions" class="shop-btn">View Latest Auctions</a>
							</div>
						</div>
		...
		<!-- <div class="slider-wrapper" style="background-image:url(img/slider/bid.png);width: 100%;">
			<div class="container-fluid">
				<div class="row">
					<div class="col">
						<div class="slider-text-info style-2 text-center slider-text-animation">
				...
				<div class="row">
					<div class="col">
						<div class="slider-text-info style-2 text-center slider-text-animation">
							...
							<p>Convinient auction platform..</p>
							<div class="slier-btn-1">
								<a title="Bid now" href="latestauction.php?auctiontype=Latest%20Auctions" class="shop-btn">View Upcoming Auctions</a>
							</div>
						</div>
					</div>
				</div>

...
{
	$productid_val = (!empty($productid) && $productid != 0) ? "'$productid'" : "NULL";
	$sql ="INSERT INTO message(sender_id,receiver_id,message_date_time,product_id,message,status) values('$_POST[senderid]','$_POST[receiverid]','$dttim',$productid_val,'$_POST[message]','Customer')";

...
<form action="" method="post"> 
	<p class="coupon-input form-row-first">
		<label>Full Name<span class="required">*</span> <span class="errormsg"  id="errcustomer_name"></span></label>
  ...
  <div class="modal-dialog" style="max-width: 50%;">
	...
	<p class="coupon-input form-row-first">
      ...
      <div class="modal-footer">
			<button value="submit" name="submit" id="submit" class="button-login" type="submit" onclick="return validateotp()">Complete Registration</button>
      </div>
    </div>
  </div>
</div>
...
function validatecustomer()
{
	...
	var phonenum = /^\+?(?:977)?[ -]?(?:(?:(?:98|97)-?\d{8})|(?:01-?\d{7}))$/;
	...
	{
		document.getElementById("errpassword").innerHTML ="Password should contain at least one digit, one lower case, one upper case and 8 characters....";
		errchk = "True";
	}
	...
	if(!document.getElementById("mobile_no").value.match(phonenum))
	{
		document.getElementById("errmobile_no").innerHTML = "Entered Mobile number is not valid....";
		errchk = "True";
	}
	if(errchk == "True")
	{

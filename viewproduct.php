...
<!-- about -->
		...
		<br/>
			<h3 style="text-align: center; font-weight: bold;">View Product</h3>
			<br/>
...
?>				
		...
		while($rs = mysqli_fetch_array($qsql))
		{
			...
			echo "<tr><td>";
?>
<div style="width:100px; height:80px; overflow:hidden; display:flex; align-items:center; justify-content:center; background:#f9f9f9;">
<?php
for($iimg = 0; $iimg <count($arr_pro_img); $iimg++)
{
?>
  <img class="mySlides<?php echo $rs[0]; ?>" src="imgproduct/<?php echo $arr_pro_img[$iimg]; ?>" style="max-width:100px; max-height:80px; width:auto; height:auto; object-fit:contain;">
<?php
}
?>
</div>

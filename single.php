...
<div class="row">
	...
	if($_SESSION['customer_id'] != $rsproduct['customer_id'])
	{
		...
		{
			echo "<b style='color:red'><a href='customerlogin.php' class='btn btn-info'>Login to chat..</a></b><hr>";
		}
	}
	?>
	</div>
...
<div class="description-content">
	...
	<?php
		...
		{
		echo "$rsedit[customer_name] bidded Rs.". $rsedit['bidding_amount'] ." on $rsedit[bidding_date_time]<hr>";
		}
	?>
	</p>
</div>
...
function countdowntimer(id, time)
{
		...
		if (distance < 0) {
			...
			document.getElementById("countdowntime"+id).innerHTML = "<center><b  style='color: red;'>EXPIRED</b></center>";
                                            ...
                                            <div class="price-box">
<p><b>Actual product cost</b> : Rs<?php echo $rsproduct['product_cost']; ?></p> <h4>Current Bid Amount : <br>Rs<?php echo $rsproduct['ending_bid']; ?></h4>

<input type='hidden' name='max_bid_amt' id='max_bid_amt' value='<?php echo $rsproduct['ending_bid']+50; ?>'>
